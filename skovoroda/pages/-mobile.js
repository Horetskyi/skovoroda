...
export default function HomePageMobile({sourcesTextContent}) {
  ...
  function ListH2(title) {
    return <Title order={2} mb={28} ta={"center"}>{title}</Title>
  }
  ...
  return (
    <>
      <SkColoredContainerMobile color="white">

        {/* Title Section */}
        <Box className={classes.headerContainer}>
          <Title order={1} className={classes.h1} ta="center">
            <p>Григорій</p>
            <p>Варсава</p>
            <p>Сковорода</p>
          </Title>
          <Text className={classes.date} mt="md" mb="xl" ta="center">
            1722 — 1794
          </Text>
        </Box>
        ...
        {/* Name Section */}
        <Box className={classes.nameSection} px="md" pt="xs">
          <Title order={2} ta="center" mb="md" mt="lg">Син миру</Title>
          <Text className={`normalContentText normalContentText_withoutIndent`} ta="center">
            ...
            Також ім’я батька Сковороди
          </Text>
        </Box>
      </SkColoredContainerMobile>

      <SkColoredContainerMobile color="white" px="md">
        ...
        <Box mt="sm">
          ...
          <Link className={`${classes.linkContainer} linkWithoutDecoration`} href={philosopherReadMoreLink.href} title={philosopherReadMoreLink.title} target="_self" >
