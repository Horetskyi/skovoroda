const dictionary = [
  ...
  [ "я", "я, йому, їй" ],
  [ "отрыгалися", [
    "1. Буквальне (фізіологічне) значення: відригнути, вивергнути з шлунку",
    "2. Переносне значення: відмовитися від чогось, відкинути, відвернутися, не прийняти, не визнати",
    "3. Як образ моральної дії: виявити назовні внутрішню нечистоту або зло; грішник \"відригає\" зло, що в ньому є."
  ]],
  [ ["жжет", "жжёт", "жечь"], [
    "1. Буквально: палить, опікає, обпалює",
    "2. Переносно: викликає мучення совісті, гризоту, духовний біль", 
  ]],
  [ "глад", "голод" ],
...
dictionary.forEach(item => {
  ...
  if (Array.isArray(item[0])) {
    ...
    dictionaryMap.set(item[0], explanation);
  }
});
